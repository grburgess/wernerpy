...
rtds_action_github_repo = "grburgess/wernerpy"
...
latex_documents = [
    (master_doc, 'wernerpy.tex', u'wernerpy Documentation',
...
man_pages = [(master_doc, 'wernerpy', u'wernerpy Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'wernerpy', u'wernerpy Documentation', author, 'wernerpy',
